...
/**
 * Character reputation/morality options.
 * @enum {string}
 */
DND5E.alignments = {
  paragon: "ME.ReputationParagon",
  neutral: "ME.ReputationNeutral",
  renegade: "ME.ReputationRenegade"
};
 ...
 */
DND5E.weaponTypes = {
  assaultRifle: "ME.WeaponAssaultRifle",
  pistol: "ME.WeaponPistol",
  shotgun: "ME.WeaponShotgun",
  sniperRifle: "ME.WeaponSniperRifle",
  smg: "ME.WeaponSMG",
  heavy: "ME.WeaponHeavy",
  melee: "ME.WeaponMelee"
};
...
DND5E.weaponProficiencies = {
  smallArms: "ME.WeaponSmallArmsProficiency",
  heavyWeapons: "ME.WeaponHeavyWeaponsProficiency"
};
...
DND5E.weaponProficienciesMap = {
  assaultRifle: "smallArms",
  pistol: "smallArms",
  shotgun: "smallArms",
  sniperRifle: "smallArms",
  smg: "smallArms",
  heavy: "heavyWeapons",
  melee: "smallArms"
};
...
DND5E.creatureTypes = {
  humanoid: {
    label: "ME.CreatureHumanoid",
    plural: "ME.CreatureHumanoidPl",
    icon: "icons/environment/people/group.webp"
  },
  reaper: {
    label: "ME.CreatureReaper",
    plural: "ME.CreatureReaperPl",
    icon: "icons/creatures/tentacles/tentacle-eyes-yellow-pink.webp"
  },
  synthetic: {
    label: "ME.CreatureSynthetic",
    plural: "ME.CreatureSyntheticPl",
    icon: "icons/creatures/magical/construct-stone-earth-gray.webp"
  },
  wildlife: {
    label: "ME.CreatureWildlife",
    plural: "ME.CreatureWildlifePl",
 ...
 */
DND5E.armorTypes = {
  light: "ME.EquipmentLight",
  medium: "ME.EquipmentMedium",
  heavy: "ME.EquipmentHeavy",
  shields: "ME.EquipmentShields"
};
 ...
 */
DND5E.vehicleTypes = {
  ground: "ME.VehicleTypeGround",
  shuttle: "ME.VehicleTypeShuttle",
  frigate: "ME.VehicleTypeFrigate",
  cruiser: "ME.VehicleTypeCruiser"
};
...
DND5E.armorProficiencies = {
  lgt: "ME.ArmorLightProficiency",
  med: "ME.ArmorMediumProficiency",
  hvy: "ME.ArmorHeavyProficiency",
  shl: "ME.EquipmentShieldsProficiency"
};
...
DND5E.consumableTypes = {
  ammo: {
    label: "ME.CONSUMABLE.Type.Ammunition.Label",
    subtypes: {
      thermalClip: "ME.CONSUMABLE.Type.Ammunition.ThermalClip",
      heavyAmmo: "ME.CONSUMABLE.Type.Ammunition.HeavyAmmo"
    }
  },
  mediGel: {
    label: "ME.CONSUMABLE.Type.MediGel.Label"
  },
  grenade: {
    label: "ME.CONSUMABLE.Type.Grenade.Label",
    subtypes: {
      frag: "ME.CONSUMABLE.Type.Grenade.Frag",
      incendiary: "ME.CONSUMABLE.Type.Grenade.Incendiary",
      cryo: "ME.CONSUMABLE.Type.Grenade.Cryo",
      tech: "ME.CONSUMABLE.Type.Grenade.Tech"
    }
  },
  powerCell: {
    label: "ME.CONSUMABLE.Type.PowerCell.Label"
  },
  module: {
    label: "ME.CONSUMABLE.Type.Module.Label"
  }
};
preLocalize("consumableTypes", { key: "label", sort: true });
preLocalize("consumableTypes.ammo.subtypes", { sort: true });
preLocalize("consumableTypes.grenade.subtypes", { sort: true });
...
DND5E.focusTypes = {
  omniTool: {
    label: "ME.Focus.OmniTool",
    itemIds: {
      basic: "Compendium.massEffect.equipment24.Item.omnitoolBasic",
      advanced: "Compendium.massEffect.equipment24.Item.omnitoolAdvanced",
      master: "Compendium.massEffect.equipment24.Item.omnitoolMaster"
    }
  },
  bioticAmp: {
    label: "ME.Focus.BioticAmp",
    itemIds: {
      basic: "Compendium.massEffect.equipment24.Item.ampBasic",
      advanced: "Compendium.massEffect.equipment24.Item.ampAdvanced",
      master: "Compendium.massEffect.equipment24.Item.ampMaster"
    }
  }
};
 ...
 * The conversion number defines how many of that currency are equal to one CR (Credit).
 * @enum {CurrencyConfiguration}
 */
DND5E.currencies = {
  cr: {
    label: "ME.CurrencyCR",
    abbreviation: "ME.CurrencyAbbrCR",
    conversion: 1,
    icon: "systems/massEffect/icons/currency/credit.webp"
  },
  gel: {
    label: "ME.CurrencyGel",
    abbreviation: "ME.CurrencyAbbrGel",
    conversion: 0.01,
    icon: "systems/massEffect/icons/currency/omnigel.webp"
  }
};
...
DND5E.damageTypes = {
  kinetic: {
    label: "ME.DamageKinetic",
    icon: "systems/massEffect/icons/svg/damage/kinetic.svg",
    isPhysical: true,
    color: new Color(0xC0C0C0)
  },
  thermal: {
    label: "ME.DamageThermal",
    icon: "systems/massEffect/icons/svg/damage/thermal.svg",
    color: new Color(0xFF4500)
  },
  electric: {
    label: "ME.DamageElectric",
    icon: "systems/massEffect/icons/svg/damage/electric.svg",
    color: new Color(0x1E90FF)
  },
  biotic: {
    label: "ME.DamageBiotic",
    icon: "systems/massEffect/icons/svg/damage/biotic.svg",
    color: new Color(0x800080)
  },
  tech: {
    label: "ME.DamageTech",
    icon: "systems/massEffect/icons/svg/damage/tech.svg",
    color: new Color(0xFF1493)
  },
  cryo: {
    label: "ME.DamageCryo",
    icon: "systems/massEffect/icons/svg/damage/cryo.svg",
...
DND5E.travelPace = Object.freeze({
  infiltration: {
    label: "ME.Travel.Pace.Infiltration",
    standard: 18,
    multiplier: 2 / 3
  },
  patrol: {
    label: "ME.Travel.Pace.Patrol",
    standard: 24,
    multiplier: 1
  },
  sprint: {
    label: "ME.Travel.Pace.Sprint",
    standard: 30,
    multiplier: 4 / 3
  }
});
...
DND5E.restTypes = {
  field: {
    ...
    label: "ME.REST.Field.Label",
    icon: "fa-solid fa-medkit",
    activationPeriods: ["fieldRest"],
    recoverPeriods: ["sr"],
  ...
  full: {
    ...
    exhaustionDelta: -1,
    label: "ME.REST.Full.Label",
    icon: "fa-solid fa-ship",
    activationPeriods: ["fullRest"],
    recoverHitDice: true,
 ...
 */
DND5E.senses = {
  scanner: "ME.SenseScanner",
  thermal: "ME.SenseThermal",
  motion: "ME.SenseMotionSensor",
  radar: "ME.SenseRadarPing"
};
...
DND5E.attackClassifications = {
  ...
  spell: {
    label: "ME.ATTACK.Classification.Power"
  },
  unarmed: {
...
DND5E.spellcasting = {
  atwill: {
    label: "ME.POWER.METHODS.AtWill.label",
    order: -30
  },
  biotic: {
    label: "ME.POWER.METHODS.Biotic.label",
    order: -20
  },
  tech: {
    label: "ME.POWER.METHODS.Tech.label",
    order: -10
  },
  combat: {
    label: "ME.POWER.METHODS.Combat.label",
    type: "single",
    cantrips: true,
    prepares: true,
    order: 10,
    ...
    progression: {
      combat: {
        label: "ME.POWER.METHODS.Combat.Full.label",
        divisor: 1
      }
    }
  },
  spell: {
    label: "ME.POWER.METHODS.Power.label",
    type: "multi",
    cantrips: true,
    prepares: true,
    order: 20,
    img: "systems/massEffect/icons/power-tiers/{id}.webp",
    table: SPELL_SLOT_TABLE,
    progression: {
      full: {
        label: "ME.POWER.METHODS.Power.Full.label",
        divisor: 1
      },
      half: {
        label: "ME.POWER.METHODS.Power.Half.label",
        divisor: 2,
        roundUp: true
      },
      third: {
        label: "ME.POWER.METHODS.Power.Third.label",
        divisor: 3
      },
      hybrid: {
        label: "ME.POWER.METHODS.Power.Hybrid.label",
        divisor: 2,
        roundUp: true
      }
    }
...
/**
 * Power preparation states.
 * @type {Record<string, SpellcastingPreparationState5e>}
 */
DND5E.spellPreparationStates = {
  unprepared: {
    label: "ME.POWER.STATES.Unprepared",
    value: 0
  },
  prepared: {
    label: "ME.POWER.STATES.Prepared",
    value: 1
  },
  always: {
    label: "ME.POWER.STATES.AlwaysAvailable",
    value: 2
  }
};
...
/**
 * Power types to which a power can belong.
 * @enum {SpellSchoolConfiguration}
 */
DND5E.spellSchools = {
  biotic: {
    label: "ME.PowerBiotic",
    icon: "systems/massEffect/icons/svg/schools/biotic.svg",
    fullKey: "biotic"
  },
  tech: {
    label: "ME.PowerTech",
    icon: "systems/massEffect/icons/svg/schools/tech.svg",
    fullKey: "tech"
  },
  combat: {
    label: "ME.PowerCombat",
    icon: "systems/massEffect/icons/svg/schools/combat.svg",
    fullKey: "combat"
  }
};
...
DND5E.languages = {
  standard: {
    label: "ME.Language.Category.Standard",
    selectable: false,
    children: {
      galactic: "ME.Language.Language.GalacticStandard",
      translator: "ME.Language.Language.UniversalTranslator"
    }
  },
  species: {
    label: "ME.Language.Category.Species",
    selectable: false,
    children: {
      asari: "ME.Language.Language.Asari",
      turian: "ME.Language.Language.Turian",
      salarian: "ME.Language.Language.Salarian",
      krogan: "ME.Language.Language.Krogan",
      quarian: "ME.Language.Language.Quarian",
      volus: "ME.Language.Language.Volus",
      drell: "ME.Language.Language.Drell",
      batarian: "ME.Language.Language.Batarian",
      vorcha: "ME.Language.Language.Vorcha",
      geth: "ME.Language.Language.Geth",
      elcor: "ME.Language.Language.Elcor",
      hanar: "ME.Language.Language.Hanar"
    }
  }
};
preLocalize("languages", { key: "label" });
preLocalize("languages.standard.children", { key: "label", sort: true });
preLocalize("languages.species.children", { key: "label", sort: true });
