...
export default class MultiActorSheet extends BaseActorSheet {
  ...
  async _prepareMemberPortrait(actor, context) {
    const showTokenPortrait = this.actor.getFlag(game?.system?.id ?? "massEffect", "showTokenPortrait");
  ...
  static addDocumentSheetConfigOptions(app, html) {
    ...
    const showTokenPortrait = doc.getFlag(game?.system?.id ?? "massEffect", "showTokenPortrait");
    const artOptions = {
    ...
    fieldset.innerHTML = `
      ...
      <div class="form-group">
        ...
        <div class="form-fields">
          <select name=`flags.${game.system.id}.'>
