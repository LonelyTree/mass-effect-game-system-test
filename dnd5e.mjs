/**
 * The Mass Effect Trilogy game system for Foundry Virtual Tabletop
 * A system for playing Mass Effect trilogy adventures.
 * Converted from D&D 5e Foundry VTT system
...
Hooks.once("init", function() {
  ...
  utils.log(`Initializing the Mass Effect Trilogy Game System - Version ${dnd5e.version}\n${DND5E.ASCII}`);
